...
var // packages
  _ = __webpack_require__(/*! ../util */ "./lib/util.js"),
 animate = __webpack_require__(/*! ../helper/animate */ "./lib/helper/animate.js"),
 dom = __webpack_require__(/*! ../dom */ "./lib/dom.js"),
 Regular = __webpack_require__(/*! ../render/client */ "./lib/render/client.js");
...
// Regular
var _ = __webpack_require__(/*! ../util */ "./lib/util.js");
var dom = __webpack_require__(/*! ../dom */ "./lib/dom.js");
var animate = __webpack_require__(/*! ../helper/animate */ "./lib/helper/animate.js");
var Regular = __webpack_require__(/*! ../render/client */ "./lib/render/client.js");
var consts = __webpack_require__(/*! ../const */ "./lib/const.js");
...
__webpack_require__(/*! ./event.js */ "./lib/directive/event.js");
__webpack_require__(/*! ./form.js */ "./lib/directive/form.js");
...
var _ = __webpack_require__(/*! ../util */ "./lib/util.js");
var dom = __webpack_require__(/*! ../dom */ "./lib/dom.js");
var OPTIONS = (__webpack_require__(/*! ../const */ "./lib/const.js").OPTIONS)
var STABLE = OPTIONS.STABLE;
var hasInput;
var Regular = __webpack_require__(/*! ../render/client */ "./lib/render/client.js");
...
var _ = __webpack_require__(/*! ./util */ "./lib/util.js");
var combine = __webpack_require__(/*! ./helper/combine */ "./lib/helper/combine.js")
...
const env = __webpack_require__(/*! ../env */ "./lib/env.js");
...
var dom = __webpack_require__(/*! ../dom */ "./lib/dom.js");
var animate = __webpack_require__(/*! ./animate */ "./lib/helper/animate.js");
...
var _ = __webpack_require__(/*! ../util */ "./lib/util.js");
var diffTrack = __webpack_require__(/*! ./diffTrack */ "./lib/helper/diffTrack.js");
...
var dconst = (__webpack_require__(/*! ../const */ "./lib/const.js").DIFF)
...
// ===============================
var _ = __webpack_require__(/*! ../util.js */ "./lib/util.js");
var fallbackEvent = {
  destroy: '$destroy',
  update: '$update',
  init: '$init',
...
var exprCache = (__webpack_require__(/*! ../env */ "./lib/env.js").exprCache);
var _ = __webpack_require__(/*! ../util */ "./lib/util.js");
var Parser = __webpack_require__(/*! ../parser/Parser */ "./lib/parser/Parser.js");
module.exports = {
...
var _ = __webpack_require__(/*! ../util */ "./lib/util.js");
var parseExpression = (__webpack_require__(/*! ./parse */ "./lib/helper/parse.js").expression);
var diff = __webpack_require__(/*! ./diff */ "./lib/helper/diff.js");
var diffTrack = __webpack_require__(/*! ./diffTrack */ "./lib/helper/diffTrack.js");
var diffArray = diff.diffArray;
var diffObject = diff.diffObject;
const { activeWatcherManager } = __webpack_require__(/*! ../reactive/activeWatcherManager */ "./lib/reactive/activeWatcherManager.js");
const { reactive, toRaw } = __webpack_require__(/*! ../reactive */ "./lib/reactive/index.js");
const { update_immediately } = __webpack_require__(/*! ../scheduler */ "./lib/scheduler/index.js");
...
var Regular = module.exports = __webpack_require__(/*! ./render/client */ "./lib/render/client.js");
var Parser = Regular.Parser;
var Lexer = Regular.Lexer;

// if(env.browser){
    __webpack_require__(/*! ./directive/base */ "./lib/directive/base.js");
    __webpack_require__(/*! ./directive/animation */ "./lib/directive/animation.js");
    __webpack_require__(/*! ./module/timeout */ "./lib/module/timeout.js");
    Regular.dom = __webpack_require__(/*! ./dom */ "./lib/dom.js");
// }
Regular.env = env;
Regular.util = __webpack_require__(/*! ./util */ "./lib/util.js");
...
Regular.Cursor =__webpack_require__(/*! ./helper/cursor */ "./lib/helper/cursor.js") 

Regular.isServer = env.node;
Regular.isRegular = function( Comp ){
  return  Comp.prototype instanceof Regular;
}
Regular.reactive = (__webpack_require__(/*! ../lib/reactive */ "./lib/reactive/index.js").reactive);



/***/ }),

/***/ "./lib/module/timeout.js":
/*!*******************************!*\
  !*** ./lib/module/timeout.js ***!
  \*******************************/
/***/ ((__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
...
var _ = __webpack_require__(/*! ../util */ "./lib/util.js");
var config = __webpack_require__(/*! ../config */ "./lib/config.js");
var createFSM = __webpack_require__(/*! ./FSM */ "./lib/parser/FSM.js");
...
var config = __webpack_require__(/*! ../config */ "./lib/config.js");
var node = __webpack_require__(/*! ./node */ "./lib/parser/node.js");
var Lexer = __webpack_require__(/*! ./Lexer */ "./lib/parser/Lexer.js");
...
/***/ "./lib/reactive/activeWatcherManager.js":
/*!**********************************************!*\
  !*** ./lib/reactive/activeWatcherManager.js ***!
  \**********************************************/
/***/ ((module) => {
...
/* harmony export */ });
const { activeWatcherManager } = __webpack_require__(/*! ./activeWatcherManager */ "./lib/reactive/activeWatcherManager.js");

const {updateDeps} = __webpack_require__(/*! ../scheduler */ "./lib/scheduler/index.js");
const { extend, isArray, isMap, isIntegerKey, hasOwn, isSymbol, isObject, hasChanged, makeMap, capitalize, toRawType, def, isFunction, NOOP } = __webpack_require__(/*! @vue/shared */ "./node_modules/.pnpm/@vue+shared@3.2.47/node_modules/@vue/shared/dist/shared.esm-bundler.js");
const env = __webpack_require__(/*! ../env */ "./lib/env.js");

const ITERATE_KEY = Symbol('iterate' );
const MAP_KEY_ITERATE_KEY = Symbol('Map key iterate' );
const {buryTime} = __webpack_require__(/*! ../helper/bury */ "./lib/helper/bury.js");
...
var env = __webpack_require__(/*! ../env */ "./lib/env.js");
var Lexer = __webpack_require__(/*! ../parser/Lexer */ "./lib/parser/Lexer.js");
var Parser = __webpack_require__(/*! ../parser/Parser */ "./lib/parser/Parser.js");
var config = __webpack_require__(/*! ../config */ "./lib/config.js");
var _ = __webpack_require__(/*! ../util */ "./lib/util.js");
var extend = __webpack_require__(/*! ../helper/extend */ "./lib/helper/extend.js");
var shared = __webpack_require__(/*! ./shared */ "./lib/render/shared.js");
var combine = {};
if(env.browser){
  var dom = __webpack_require__(/*! ../dom */ "./lib/dom.js");
  var walkers = __webpack_require__(/*! ../walkers */ "./lib/walkers.js");
  var Group = __webpack_require__(/*! ../group */ "./lib/group.js");
  var doc = dom.doc;
  combine = __webpack_require__(/*! ../helper/combine */ "./lib/helper/combine.js");
}
var events = __webpack_require__(/*! ../helper/event */ "./lib/helper/event.js");
var Watcher = __webpack_require__(/*! ../helper/watcher */ "./lib/helper/watcher.js");
var parse = __webpack_require__(/*! ../helper/parse */ "./lib/helper/parse.js");
var filter = __webpack_require__(/*! ../helper/filter */ "./lib/helper/filter.js");
var ERROR = (__webpack_require__(/*! ../const */ "./lib/const.js").ERROR);
var nodeCursor = __webpack_require__(/*! ../helper/cursor */ "./lib/helper/cursor.js");
var shared = __webpack_require__(/*! ./shared */ "./lib/render/shared.js");
const { buryTime } = __webpack_require__(/*! ../helper/bury */ "./lib/helper/bury.js");
const { activeWatcherManager, runWithoutTrack } = __webpack_require__(/*! ../reactive/activeWatcherManager */ "./lib/reactive/activeWatcherManager.js");
const { updateDeps } = __webpack_require__(/*! ../scheduler */ "./lib/scheduler/index.js");
var NOOP = function(){};
...
var Regular = function(definition, options){
  ...
  if( context.init ) {
    runWithoutTrack(() => {
      context.init( context.data );
    });
  }
  context.$emit("$afterInit");
  context.$ready = true;

  // fix: config中的this.$watch('value', fn)无法在组件compile之后执行fn()
  const needCheckWatchers = (context._watchers || []).concat(context._watchersForStable || []).filter(watcher => !watcher.checked);
  if (needCheckWatchers.length) {
    updateDeps(new Set([needCheckWatchers]));
  }
...
Regular.implement({
  ...
  _sg_:function(path, parent, defaults, ext){
    ...
    let valInparent = parent && parent[path];
    if(parent && typeof valInparent !== 'undefined') {
      return valInparent;
    }
...
var config = __webpack_require__(/*! ../config */ "./lib/config.js");
var parse = __webpack_require__(/*! ../helper/parse */ "./lib/helper/parse.js");
var node = __webpack_require__(/*! ../parser/node */ "./lib/parser/node.js");
const { runWithoutTrack, ignoreTrackWrap } = __webpack_require__(/*! ../reactive/activeWatcherManager */ "./lib/reactive/activeWatcherManager.js");
const {reactive} = __webpack_require__(/*! ../reactive */ "./lib/reactive/index.js")

const idGenerator = _.createAutoIncrementIdGenerator();
console.log('🦊I am Reactive Regular🦊');
...
function initDefinition(context, definition, beforeConfig){
 ...
 // template is a string (len < 16). we will find it container first
  ...
  if( context.data ) _.extend( definition.data, _.cloneDeep(context.data) );
  ...
  context._cid = (context.name || '') + idGenerator();
  function customGetter(target, key, receiver) {
    if (key === '_compId') {
      return context._cid;
    }
    return '__skip__';
  ...
  function customSetter(target, key, value, receiver) {
    let oldValue = target[key];
    return '__skip__';
  }
  const data = context.data = reactive(context.data);
  ...
  beforeConfig && runWithoutTrack(() => beforeConfig());
  ...
  ['mount', 'leave', 'enter', 'destroy'].forEach(name => {
    if (context[name]) {
      context[name] = ignoreTrackWrap(context[name])
    }
  });
  context.$emit( "$config", context.data );
  if (context.config) {
    runWithoutTrack(() => context.config(context.data))
  }
...
module.exports = __webpack_require__(/*! ./scheduler */ "./lib/scheduler/scheduler.js");
...
__webpack_require__(/*! ./helper/shim */ "./lib/helper/shim.js")();

const lodash = __webpack_require__(/*! lodash */ "./node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/lodash.js");


var _  = module.exports;
var entities = __webpack_require__(/*! ./helper/entities */ "./lib/helper/entities.js");
var o2str = ({}).toString;
var win = typeof window !=='undefined'? window: __webpack_require__.g;
var MAX_PRIORITY = 9999;
var config = __webpack_require__(/*! ./config */ "./lib/config.js");
const { ignoreTrackWrap } = __webpack_require__(/*! ./reactive/activeWatcherManager */ "./lib/reactive/activeWatcherManager.js");
...
_.normListener = function( events  ){
    ...
    if( pType === 'array' ){
      ...
      for( var i in events ) if ( events.hasOwnProperty(i) ){
        eventListeners.push({
          type: i,
          listener: ignoreTrackWrap(events[i]),
        })
      }
    }
...
_.safeNotEqual = function(a, b) {
  return a != a ? b == b : a !== b || ((a && typeof a === 'object') || typeof a === 'function');
}

_.createAutoIncrementIdGenerator = function() {
  let i = 0;
  return function() {
    return (i++).toString();
  }
...
var diffArray = (__webpack_require__(/*! ./helper/diff */ "./lib/helper/diff.js").diffArray);
var combine = __webpack_require__(/*! ./helper/combine */ "./lib/helper/combine.js");
var animate = __webpack_require__(/*! ./helper/animate */ "./lib/helper/animate.js");
var Parser = __webpack_require__(/*! ./parser/Parser */ "./lib/parser/Parser.js");
var node = __webpack_require__(/*! ./parser/node */ "./lib/parser/node.js");
...
var nodeCursor = __webpack_require__(/*! ./helper/cursor */ "./lib/helper/cursor.js");
var config = __webpack_require__(/*! ./config */ "./lib/config.js");
var shared = __webpack_require__(/*! ./render/shared */ "./lib/render/shared.js");
var dconst = (__webpack_require__(/*! ./const */ "./lib/const.js").DIFF)
...
walkers.attribute = function(ast ,options){
  ...
  if(directive && directive.link){
    ...
    const preHandling = self.handling;
    // 为了处理directive.link中的watcher的初始化
    self.handling = 'directive';
    var binding = directive.link.call(self, element, value, name, extra);
    self.handling = preHandling;
